...
const tables = {
  "A": [
    ...
    { name: "日登 広大", relation: "新郎高専友人", img: "images/hinobori.png", description: "コミュ力お化け。学校で一緒に歩いてると色んな人と会話しだすので、めっちゃ疎外感を感じるので要注意。陸上部は球技が下手というのを覆すほど色んな球技が上手い。最近パパになりましたね。これからもよろしく！" },
